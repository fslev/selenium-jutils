...
In order to activate it, instantiate the ElementContextLocatorFactory with a specified List of Throwables upon which web element localisation should be retried and a timeout duration.
```java
