...
In order to activate it, instantiate the _ElementContextLocatorFactory_ with a specified List of Throwable objects upon which web element localisation should be retried and a duration timeout. 
```java
